...
const Index = () => {
  return (
    <div id="sports" className='container mx-auto overflow-hidden'>
      <h1 className='text-center text-[3rem] drop-shadow-header py-10'>Sports</h1>
      <div className='md:grid md:grid-cols-5 flex flex-wrap md:gap-0 gap-2  md:space-y-3 justify-center md:px-4   py-10'>
        {movies.map((movie) => (
