...
import './SportVideoCard.css'; // Import the CSS file
        ...
        <div className="video-card-front relative  ">
          ...
          />
           <div className="absolute top-27 right-3 flex items-center gap-2">
              ...
              <img src={logo} alt="Logo" className="z-10 md:w-[120px] w-[50px] absolute top-14 left-3  h-auto transition-all duration-300" />
        </div>
